...
;
const ACCOMMODATION_API = ("TURBOPACK compile-time value", "https://18223088.tesatepadang.space/") || 'http://localhost:3000';
const LIVING_SUPPORT_API = ("TURBOPACK compile-time value", "https://18223054.tesatepadang.space/") || 'http://localhost:3010';
const accommodationAxios = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ACCOMMODATION_API,
    headers: {
        'Content-Type': 'application/json'
    }
});
const livingSupportAxios = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: LIVING_SUPPORT_API,
    headers: {
        'Content-Type': 'application/json'
    }
});
livingSupportAxios.interceptors.request.use((config)=>{
...
livingSupportAxios.interceptors.response.use((response)=>{
    return response;
}, (error)=>{
...
accommodationAxios.interceptors.response.use((response)=>{
    return response;
}, (error)=>{
    if (error.response?.status !== 401) {
...
const laundryApi = {
    ...
    updateStatus: async (id, status, delivery_date, delivery_time)=>{
...
const cateringApi = {
    ...
    updateStatus: async (id, status)=>{
        const { data } = await livingSupportAxios.put(`/api/catering/${id}/status`, {
            status
        });
        return data;
    },
...
const notificationApi = {
    getAll: async (isRead, limit = 50)=>{
        ...
        const { data } = await livingSupportAxios.get('/api/notifications', {
            params
        });
        return data;
    },
...
function AuthProvider({ children }) {
    ...
    const login = async (credentials)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].login(credentials);
        localStorage.setItem('access_token', response.access_token);
        localStorage.setItem('user', JSON.stringify(response.user));
        setUser(response.user);
    };
    const register = async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authApi"].register(data);
        localStorage.setItem('access_token', response.access_token);
        localStorage.setItem('user', JSON.stringify(response.user));
        setUser(response.user);
    };
...
function Navbar() {
    _s();
    const { user, isAuthenticated, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const fetchUnreadCount = async ()=>{
        try {
            const { unread_count } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notificationApi"].getUnreadCount();
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "sticky top-0 z-50 shadow-lg bg-primary-900",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    children: [
                                        ...
                                        unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "absolute -top-1 -right-1 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-lg border-2",
                                            style: {
...
_s(Navbar, "feezDVGITgQeOLuQkkEhGxP4bKM=", false, function() {
    return [
...
//# sourceMappingURL=app_9befdfdc._.js.map